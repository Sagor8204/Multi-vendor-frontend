    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-white border-b border-border sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
             <Link href="/" className="text-sm font-bold text-text-main hover:text-primary transition-colors">Home</Link>
             <Link href="/products" className="text-sm font-bold text-text-muted hover:text-text-main transition-colors">Products</Link>
             <Link href="/vendors" className="text-sm font-bold text-text-muted hover:text-text-main transition-colors">Vendors</Link>
          </div>
      ...
      <footer className="bg-background-subtle border-t border-border pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
               {['FB', 'TW', 'IG', 'LI'].map(social => (
                 <div key={social} className="w-8 h-8 rounded-full bg-border flex items-center justify-center text-[10px] font-bold text-text-muted hover:bg-primary hover:text-white cursor-pointer transition-all">{social}</div>
               ))}
            </div>
          </div>
          <div className="space-y-6">
            <h4 className="font-bold text-text-main uppercase tracking-widest text-xs">Marketplace</h4>
            <ul className="text-sm text-text-muted space-y-3 font-semibold">
          ...
          <div className="space-y-6">
            <h4 className="font-bold text-text-main uppercase tracking-widest text-xs">Support</h4>
            <ul className="text-sm text-text-muted space-y-3 font-semibold">
          ...
          <div className="bg-primary/5 p-8 rounded-2xl space-y-4 border border-primary/10">
             ...
             <p className="text-xs text-text-muted leading-relaxed font-medium">Reach millions of customers and scale your business with our premium tools.</p>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-20 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6 text-[10px] font-bold text-text-muted uppercase tracking-widest">
