...
export const ProductCard: React.FC<ProductCardProps> = ({ 
  ...
  if (variant === 'list') {
    return (
      <Card noPadding className="group h-48 bg-white transition-all duration-300 border-transparent hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative rounded-2xl overflow-hidden">
  ...
  return (
    <Card noPadding className="group h-full bg-white transition-all duration-300 border-transparent hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] relative rounded-xl overflow-hidden">
